...
class NewsController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        dd.newss = self
        dd.titlelabel.backgroundColor = UIColor.brown
    ...
    func callapi(){
        let ss = "https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=cd9a19968a734d1cb7213cc94fcee0f4"
